...
- SKU выглядят как внутренние штрихкоды EAN-13 с префиксом 2000000…
  ...
  **Этот SKU (=EAN `2000000…`) — БАЗОВЫЙ идентификатор товара и основной ключ
  сопоставления с 1С по штрихкоду (DEC-011).** SKU/названия/оригинальное название
  в KeyCRM не менять (правило владельца).
...
| CT_1007 | crm_product | text | Артикул_SKU ⚠️ внутр. код (DEC-012): виден складовщику/размещению заказа, не менеджерам/клиентам |
